...
namespace Somnium.Framework
{
    ...
    public partial struct Vector3 : IEquatable<Vector3>, IFormattable
    {
        ...
        /// <summary>
        /// Returns the Forward vector in Somnium coordinates (0, 0, -1)
        /// </summary>
        public static Vector3 Forward => new Vector3(0f, 0f, -1f);
        /// <summary>
        /// Returns the Backwards vector in Somnium coordinates (0, 0, 1)
        /// </summary>
        public static Vector3 Backward => new Vector3(0f, 0f, 1f);
        /// <summary>
        /// Returns the Up vector in Somnium 3D coordinates (0, 1, 0)
        /// </summary>
        private static Vector3 Up => new Vector3(0f, 1f, 0f);
        /// <summary>
        /// Returns the Down vector in Somnium 3D coordinates (0, -1, 0)
        /// </summary>
